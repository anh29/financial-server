...
module.exports = {
  ...
  getMonthlyBudgetWithAllocations: createGASController('getMonthlyBudgetWithAllocations'),
  ...
  predictRecurringTransactions: createGASController('predictRecurringTransactions'),
